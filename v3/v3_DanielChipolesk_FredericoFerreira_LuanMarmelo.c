...
int cadastroPessoas(int cadastrado, Pessoa pessoas[], char categ[QTD_PREF][20]);
void exibirPessoas(int cadastrado, Pessoa pessoas[], char categ[QTD_PREF][20]);
float distanciaEuclidianaAB(int pessoaA, int pessoaB, Pessoa pessoas[]);
...
int main()
{
    ...
    do
    {
        ...
        {
            case 1:
                cadastrado = cadastroPessoas(cadastrado, pessoas, categ);
                break;
                            ...
                            Pessoa pessoas[])
{
    ...
    {
        soma += pow(pessoas[pessoaA].notas[i]
                    - pessoas[pessoaB].notas[i], 2);
    }
                         ...
                         Pessoa pessoas[])
{
    ...
    distancia = distanciaEuclidianaAB(pessoaA, pessoaB, pessoas);
                        ...
                        Pessoa pessoas[])
{
    ...
    for (i = 0; i < cadastrado; i++)
    {
        if (i != pessoaOrigem)
        {
            distancia = distanciaEuclidianaAB(pessoaOrigem, i, pessoas);
                            ...
                            Pessoa pessoas[])
{
    ...
    for (i = 0; i < cadastrado; i++)
    {
        if (i != pessoaOrigem)
        {
            ...
            auxDistancias[quantidade] = distanciaEuclidianaAB(pessoaOrigem, i, pessoas);
            quantidade++;
        }
    }
                      ...
                      char categ[QTD_PREF][20])
{
    ...
    printf("\nDistancia Euclidiana: %.2f\n",
           distanciaEuclidianaAB(pessoaA, pessoaB, pessoas));
